...
function Footer2()
  ...
  //N�mero de p�gina
  $this->Cell(190,5,'SOFT RESTAURANT (Administraci�n, Compras y ventas)','T',0,'L');
  $this->AliasNbPages();
...
########################## FUNCION LISTAR PROVINCIAS ##############################
      function TablaListarProvincias()
   {
    ...
    $this->Cell(100,5,"GESTI�N Y CONTROL PARA RESTAURANTES",0,0,'C');
    ...
    $this->Ln();
    $this->Cell(45,5,"",0,0,'C');
    $this->Cell(100,5,"N� DE TLF: ".utf8_decode($con[0]['tlfsucursal']),0,0,'C');
    $this->Cell(45,5,"",0,0,'C');
...
########################## FUNCION LISTAR USUARIOS ##############################
      function TablaListarUsuarios()
   {
    ...
    $this->Cell(240,5,"GESTI�N Y CONTROL PARA RESTAURANTES",0,0,'C');
...
function TablaListarRestaurantes()
{
 ...
 $this->SetFont('Courier','B',14);  
 $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
 $this->Cell(330,10,'LISTADO GENERAL DE RESTAURANTES',0,0,'C');
 ...
 $this->SetFillColor(230, 126, 34); // establece el color del fondo de la celda (en este caso es NARANJA)
 $this->Cell(10,8,'N�',1,0,'C', True);
 $this->Cell(30,8,'N� REGISTRO',1,0,'C', True);
 $this->Cell(60,8,'NOMBRE/RAZON SOCIAL',1,0,'C', True);
 $this->Cell(40,8,'N� TELEFONO',1,0,'C', True);
 $this->Cell(45,8,'CORREO ELECTRONICO',1,0,'C', True);
 $this->Cell(60,8,'DIRECCION',1,0,'C', True);
 $this->Cell(40,8,'N� DOC ENCARGADO',1,0,'C', True);
 $this->Cell(40,8,'NOMBRE DE ENCARGADO',1,1,'C', True);
 ...
 echo "";      
  ...
  /* AQUI DECLARO LAS COLUMNAS */
 $this->SetWidths(array(10,30,60,40,45,60,40,40));
 ...
 $this->SetFont('Courier','',10);  
 $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
 $this->Row(array($a++,utf8_decode($reg[$i]["cuit"]),utf8_decode($reg[$i]["nomsucursal"]),utf8_decode($reg[$i]["tlfsucursal"]),utf8_decode($reg[$i]["correosucursal"]),utf8_decode($reg[$i]["direcsucursal"]),utf8_decode($reg[$i]["dniencargado"]),utf8_decode($reg[$i]["nomencargado"])));
     }
   }
...
######################## FUNCION LISTAR INGREDIENTES VENDIDOS #########################
      function TablaListarIngredientesVendidos()
   {
    ...
    $this->Cell(85,8,'DESCRIPCI�N DE INGREDIENTE',1,0,'C', True);
...
########################## FUNCION LISTAR PRODUCTOS ##############################
      function TablaListarProductos()
   {
    ...
    $this->Cell(15,8,'N�',1,0,'C', True);
    $this->Cell(25,8,'C�DIGO',1,0,'C', True);
    $this->Cell(80,8,'DESCRIPCI�N',1,0,'C', True);
...
####################### FUNCION LISTAR PRODUCTOS EN STOCK MINIMO ##############################
      function TablaListarProductosMinimo()
   {
    ...
    $this->CellFitSpace(40,5,utf8_decode($simbolo.number_format($TotalVenta, 0, '.', '.')),1,0,'L');
    $this->CellFitSpace(30,5,utf8_decode($cambio[0]['simbolo'].number_format($TotalMoneda, 0, '.', '.')),1,0,'L');
    $this->CellFitSpace(30,5,utf8_decode(number_format($TotalArticulos, 0, '.', '.')),1,0,'L');
    $this->Ln();
   }
...
####################### FUNCION LISTAR PRODUCTOS EN STOCK MAXIMO ##############################
      function TablaListarProductosMaximo()
   {
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(330,7,'LISTADO GENERAL DE PRODUCTOS EN STOCK MAXIMO',0,0,'C');
    ...
    $this->Cell(40,8,'PRECIO VENTA',1,0,'C', True);
    $this->Cell(30,8,'EXISTENCIA',1,0,'C', True);
    $this->Cell(30,8,'STOCK M�XIMO',1,0,'C', True);
    $this->Cell(20,8,$impuesto == '' ? "IMPUESTO" : $imp[0]['nomimpuesto'],1,0,'C', True);
    $this->Cell(20,8,'DESC',1,1,'C', True);
...
######################## FUNCION LISTAR PRODUCTOS VENDIDOS #########################
      function TablaListarProductosVendidos()
   {
    ...
    $this->Cell(15,8,'N�',1,0,'C', True);
    $this->Cell(30,8,'C�DIGO',1,0,'C', True);
    $this->Cell(95,8,'DESCRIPCI�N DE PRODUCTO',1,0,'C', True);
...
################### FUNCION LISTAR PRODUCTOS SEGUN MODENA ###################
      function TablaListarProductosxMoneda()
   {
    ...
    $this->Cell(15,8,'N�',1,0,'C', True);
    $this->Cell(30,8,'C�DIGO',1,0,'C', True);
    $this->Cell(95,8,'DESCRIPCI�N',1,0,'C', True);
    $this->Cell(30,8,'CATEGORIA',1,0,'C', True);
    $this->Cell(40,8,'PRECIO VENTA',1,0,'C', True);
...
############################## BLOQUE N� 2 #####################################   
   //BLOQUE DE DATOS DE PROVEEDOR
    ...
    $this->SetFont('courier','B',10);
    $this->SetXY(12, 38);
    $this->CellFitSpace(28, 5, 'N� DE '.$documento = ($con[0]['documsucursal'] == '0' ? "REG.:" : $con[0]['documento'].":"), 0, 0);
    $this->SetFont('courier','',10);
    $this->SetXY(40, 38);
    ...
    $this->SetFont('courier','B',10);
    $this->SetXY(230, 42);
    $this->CellFitSpace(26, 5,'N� DE '.$documento = ($con[0]['documencargado'] == '0' ? "DOC.:" : $con[0]['documento2'].":"), 0, 0);
    $this->SetFont('courier','',10);
    $this->SetXY(256, 42);
...
################################# BLOQUE N� 3 #######################################   
    ...
    $this->SetFont('courier','B',10);
    $this->SetXY(12, 52);
    $this->CellFitSpace(28, 5, 'N� DE '.$documento = ($reg[0]['documproveedor'] == '0' ? "DOC.:" : $reg[0]['documento'].":"), 0, 0);
    $this->SetFont('courier','',10);
    $this->SetXY(40, 52);
...
################################# BLOQUE N� 4 #######################################   
    ...
    $this->Cell(80,8,'DESCRIPCI�N DE PRODUCTO',1,0,'C', True);
...
########################## FUNCION LISTAR ARQUEOS DE CAJAS ##############################
      function TablaListarArqueos()
   {
    ...
    $this->SetFillColor(230, 126, 34); // establece el color del fondo de la celda (en este caso es NARANJA)
    $this->Cell(10,8,'N�',1,0,'C', True);
    $this->Cell(75,8,'N� DE CAJA',1,0,'C', True);
...
########################## FUNCION TICKET COMANDA ##############################
    ...
    $this->SetXY(4, 22);
    $this->CellFitSpace(65,3,'N� DE '.$documento = ($con[0]['documsucursal'] == '0' ? "REG.:" : $con[0]['documento'].":").utf8_decode($con[0]['cuit']), 0, 1, 'C');
    $this->SetXY(4, 25);
    $this->CellFitSpace(65,3,"N� PEDIDO:".utf8_decode($reg[0]['codpedido']."-".$reg[0]['pedido']), 0, 1, 'C');
    $this->SetXY(4, 28);
    ...
    $this->SetX(4);
    $this->CellFitSpace(66, 3, "FECHA DE IMPRESI�N: ".date("d-m-Y h:i:s A ",time()+1800),0,1,'L');
    ...
    $this->SetX(4);
    $this->CellFitSpace(65, 3, "FECHA EMISI�N: ".date("d/m/Y h:i:s A ",time()+1800),0,1,'C');
...
########################## FUNCION TICKET PREGUENTA ##############################
    ...
    $this->CellFitSpace(66, 3, "SALA: ".utf8_decode($reg[0]['nomsala']),0,1,'L');
    $this->SetX(4);
    $this->CellFitSpace(66, 3, "Nº DE MESA: ".utf8_decode($reg[0]['nommesa']),0,1,'L');
    $this->SetX(4);
    $this->CellFitSpace(66, 3, "MESERO: ".utf8_decode($reg[0]['nombres']),0,1,'L');
    $this->SetX(4);
...
########################## FUNCION TICKET VENTA ##############################
    ...
    $this->CellFitSpace(65,3,"EMISIÓN: NORMAL", 0, 1, 'C');
    $this->SetXY(4, 34);
    $this->CellFitSpace(65,3,"CLAVE DE ACCESO - Nº DE AUTORIZACIÓN", 0, 1, 'C');
    $this->SetXY(4, 37);
...
############################# BLOQUE N� 2 SUCURSAL ################################   
   //Bloque de datos de empresa
    ...
    $this->SetFont('courier','B',8);
    $this->SetXY(102, 34);
    $this->CellFitSpace(22, 4, 'N� DE '.$documento = ($con[0]['documsucursal'] == '0' ? "REG.:" : $con[0]['documento'].":"), 0, 0);
    $this->SetFont('courier','',8);
    $this->SetXY(124, 34);
    ...
    $this->SetFont('courier','B',8);
    $this->SetXY(102, 42);
    $this->CellFitSpace(22, 4, 'N� DE '.$documento = ($con[0]['documencargado'] == '0' ? "DOC.:" : $con[0]['documento2'].":"), 0, 0);
    $this->SetFont('courier','',8);
    $this->SetXY(124, 42);
...
############################## BLOQUE N� 3 CLIENTE ###################################  
    ...
    $this->SetFont('courier','B',8);
    $this->SetXY(90, 54);
    $this->CellFitSpace(20, 4, 'N� DE '.$documento = ($reg[0]['documcliente'] == '0' ? "DOC.:" : $reg[0]['documento'].":"), 0, 0);
    $this->SetFont('courier','',8);
    $this->SetXY(110, 54);
...
################################# BLOQUE N� 4 #######################################   
    ...
    $this->Cell(45, 8,"DESCRIPCI�N DE PRODUCTO", 1, 0, 'C', True);
...
########################## FUNCION LISTAR VENTAS POR CAJAS ##############################
      function TablaListarVentasxCajas()
   {
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(330,7,'LISTADO DE VENTAS EN CAJA (N�: '.utf8_decode($reg[0]["nrocaja"].": ".$reg[0]["nomcaja"]).")",0,1,'C');
    $this->Cell(330,7,"Y FECHAS (DESDE ".date("d-m-Y", strtotime($_GET["desde"]))." HASTA ".date("d-m-Y", strtotime($_GET["hasta"])).")",0,0,'C'); 
...
function TicketCredito()
    ...
    $this->SetFillColor(2,157,116);
    $this->SetXY(4, 5);
    $this->Cell(65, 5, "TICKET DE CR�DITO", 0, 0, 'C');
    $this->Ln(5);
...
########################## FUNCION LISTAR CREDITOS ##############################
   ...
   $logo = ( file_exists("./fotos/logo-pdf.png") == "" ? "./assets/images/null.png" : "./fotos/logo-pdf.png");
    ...
    $this->Cell(15,8,'N�',1,0,'C', True);
    $this->Cell(35,8,'N� DE VENTA',1,0,'C', True);
    $this->Cell(80,8,'DESCRIPCI�N DE CLIENTE',1,0,'C', True);
...
######################## FUNCION LISTAR CREDITOS POR CLIENTES #########################
      function TablaListarCreditosxClientes()
   {
    ...
    $this->Cell(15,8,'N�',1,0,'C', True);
    $this->Cell(35,8,'N� DE VENTA',1,0,'C', True);
    $this->Cell(90,8,'DESCRIPCI�N DE CLIENTE',1,0,'C', True);
    $this->Cell(40,8,'IMPORTE TOTAL',1,0,'C', True);
...
######################## FUNCION LISTAR CREDITOS POR FECHAS ##########################
      function TablaListarCreditosxFechas()
   {
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(330,7,'LISTADO DE CR�DITOS POR FECHAS (DESDE '.date("d-m-Y", strtotime($_GET["desde"]))." HASTA ".date("d-m-Y", strtotime($_GET["hasta"])).")",0,0,'C');
