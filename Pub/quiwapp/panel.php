...
if( isset($_SESSION['acceso']) ) { 
    if (
        ...
        if( isset($_POST['btn-nuevo']) ){
            ...
            exit;
        }else if( isset($_POST['btn-cerrar']) ){
            $reg = $tra->CerrarMesa();
            exit;
        ...
        <head>
           ...
           <!--Bootstrap Horizontal CSS -->
            ...
            <audio autoplay="true" muted="true" src="assets/sounds/facebook-mensaje-pling-.mp3" id="audio" controls style="display: none;"></audio>
            <!--  script jquery --> 
        ...
        <?php } else if ($_SESSION['acceso'] == "superadministrador") { ?>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-warning">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i>Lista de Restaurantes</h4>
            </div>
...
<script type="text/jscript">
    ...
    setTimeout(function() {
    $('#restaurantes').load("consultas?CargaRestaurantesPanel=si");
     }, 2000);
</script>
