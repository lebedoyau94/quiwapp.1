...
$bd="softrestaurantes"; //parametro obligatorio 
// Tipo de compresion. 
...
$conexion = new mysqli('localhost','root','root','softrestaurantes',3306) or die ("No se puede conectar con el servidor MySQL: %s\n". $conexion->connect_error);
