...
if(isset($_SESSION['acceso'])){ 
    if ($_SESSION['acceso'] == "administrador" || $_SESSION["acceso"]=="secretaria" || $_SESSION["acceso"]=="cajero"){
        ...
        if(isset($_POST["proceso"]) and $_POST["proceso"]=="save"){
            ...
            exit;
        }else if(isset($_POST["proceso"]) and $_POST["proceso"]=="update"){
            $reg = $tra->ActualizarProveedores();
            exit;
        }else if(isset($_POST['btn-proveedor'])){
            ...
            <div class="col-lg-5">
                <div class="card">
                    ...
                    <form class="form form-material" method="post" action="#" name="saveproveedores" id="saveproveedores">
                        <div id="save"><!-- error will be shown here ! --></div>
                        <div class="form-body">
                            <div class="card-body">
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <select name="id_provincia" id="id_provincia" onChange="CargaDepartamentos(this.form.id_provincia.value);" class='form-control' required="" aria-required="true">
                                                ...
                                                for($i=0;$i<sizeof($pro);$i++){ ?>
                                                    <option value="<?php echo $pro[$i]['id_provincia'] ?>">
                                                        <?php echo $pro[$i]['provincia'] ?>                                  
                                                    </option> <?php 
                                                } ?>
                                          </select> 
                                      </div>
