...
{
$reg = $tra->RegistrarUsuariosAdmin();
exit;
}
elseif(isset($_POST["proceso"]) and $_POST["proceso"]=="update")
{
$reg = $tra->ActualizarUsuarioAdmin();
exit;
}         
?>
<!DOCTYPE html>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <form class="form form-material" method="post" action="#" name="saveadmin" id="saveadmin" enctype="multipart/form-data">
                ...
                <div class="row"> 
                    <div class="col-md-3">
                        ...
                        <select name="nivel" id="nivel" class="form-control" required="" aria-required="true">
                                <option value=""> -- SELECCIONE -- </option>
                                <option value="SUPERADMINISTRADOR(A)">SUPERADMINISTRADOR(A)</option>
                            </select>         
                        </div>
                    </div>
