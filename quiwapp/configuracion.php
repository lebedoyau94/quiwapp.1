    ...
    <div class="col-lg-12">
        <div class="card">
           ...
           <div class="form-body">
            ...
            <div class="col-md-3">
                    <div class="form-group has-feedback">
                        <label class="control-label">Sala Principal: </label>
                        <i class="fa fa-bars form-control-feedback"></i>
                        <select class="form-control" id="codsala" name="codsala" required="" aria-required="true">
                            <option value="0"> -- SELECCIONE -- </option>
                            <?php
                            $dep = new Login();
                            $dep = $dep->ListarSalas();
                            for($i=0;$i<sizeof($dep);$i++){ ?>
                                <option value="<?php echo $dep[$i]['codsala'] ?>"<?php if (!(strcmp($reg[0]['codsala'], htmlentities($dep[$i]['codsala'])))) { echo "selected=\"selected\""; } ?>><?php echo $dep[$i]['nomsala'] ?></option>
                            <?php }  ?>
                        </select>
                    </div>
                </div>
