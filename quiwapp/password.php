        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    ...
                    <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Clave de ingreso</h5>
                    </div>
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                <li class="breadcrumb-item">Administración</li>
                                <li class="breadcrumb-item active" aria-current="page">Clave</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-warning">
                <h4 class="card-title text-white"><i class="fa fa-pencil"></i> Actualizar clave de ingreso</h4>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            <label class="control-label">Nueva clave de Acceso: <span class="symbol required"></span></label>
                            <input type="text" class="form-control" name="password" id="password" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Nueva clave de Acceso " autocomplete="off" required="" aria-required="true"/> 
                    ...
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            <label class="control-label">Repita Nueva clave: <span class="symbol required"></span></label>
                            <input type="text" class="form-control" name="password2" id="password2" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Repita Nueva clave" autocomplete="off" required="" aria-required="true"/> 
                            <i class="fa fa-key form-control-feedback"></i>
                        </div>
                    </div>
              </div>
