...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <form class="form form-material" method="post" action="#" name="saveuseradm" id="saveuseradm" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="row"> 
                    ...
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            <label class="control-label">Restaurante: <span class="symbol required"></span></label>
                            <i class="fa fa-bars form-control-feedback"></i>
                            <select name="empresa" id="empresa" class="form-control" required="" aria-required="true">
                                <option value=""> -- SELECCIONE -- </option>
                                <?php
                            $restaurante = new Login();
                            $restaurante = $restaurante->ListarRestaurantes();
                            for($i=0;$i<sizeof($restaurante);$i++){ ?>
                                <option value="<?php echo $restaurante[$i]['id'] ?>"<?php if (!(strcmp($reg[0]['empresa'], htmlentities($restaurante[$i]['id'])))) { echo "selected=\"selected\""; } ?>><?php echo $restaurante[$i]['nomsucursal'] ?></option>        
                            <?php } ?>
                            </select>
                        </div>
                    </div>
...
<!-- End Row -->
    ...
    setTimeout(function() {
    $('#usuarios').load("consultas?CargaUsuariosADM=si");
     }, 2000);
    </script>
    <!-- jQuery -->
